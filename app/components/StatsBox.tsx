...
const StatsBox = ({ stats, type }: { stats: Stats[]; type: string }) => {
  ...
  const styles: any = {
    ...
    hp: `bg-red-500/30 h-16 w-full rounded`,
    attack: `bg-yellow-500/30 h-16 w-full rounded`,
    defense: `bg-green-500/30 h-16 w-full rounded`,
    "special-attack": `bg-blue-500/30 h-16 w-full rounded`,
    "special-defense": `bg-indigo-500/30 h-16 w-full rounded`,
    speed: `bg-purple-500/30 h-16 w-full rounded`,
